...
class HistoryControlGraph extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _HistoryControlGraph();
}

class _HistoryControlGraph  extends State<HistoryControlGraph>{
