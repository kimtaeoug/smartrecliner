...
class HeatMultiSwitch extends StatefulWidget {
  @override
  State<StatefulWidget> createState() =>
      _HeatMultiSwitch();
}

class _HeatMultiSwitch extends State<HeatMultiSwitch> {
...
//_heatTime = _heatProvider.getHeatTime();
  ...
  Widget build(BuildContext context) {
    ...
    _checked = _heatProvider.getHeatCheck();
    _heatTime = _heatProvider.getHeatTime();
    return Container(
                  ...
                  children: [
                    InkWell(
                      onTap:(){
                        setState(() {
                          _itemIndex = 1;
                          _heatProvider.setItemIndex(_itemIndex);
                        });
                      },
