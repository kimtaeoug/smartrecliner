...
class HistoryHealthItemUI extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      _HistoryHealthItemUI(data);
}

class _HistoryHealthItemUI extends State<HistoryHealthItemUI> {

  HistoryApiResponse data;

  _HistoryHealthItemUI(this.data);
